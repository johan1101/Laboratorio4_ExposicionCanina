            ...
            <div class="card card-body"> <!-- Tarjeta de trabajo -->
                <table class="table table-dark table-striped"> <!-- Estilo de la tabla de datos -->
                    ...
                    <tbody>
                            ...
                            try {
                                ...
                                if (!misPerros.isEmpty()) {
                                    ...
                                    for (Perro perro : misPerros) {
                                        ...
                                        if ((nombre.equals(perro.getNombre())) || (nombre.equals(""))) {
                        ...
                        <tr>
                            <td colspan="6"> <%out.println("No hay perros registrados");%></td>
                            <% }%>
                    </tbody>
                </table> <!-- Cierre de la etiqueta table-->
                <center>
                <br><!--<button class="btn btn-success" href="index.jsp">Mostrar listado</button>-->
                <a class="btn btn-success" href="index.jsp">Mostrar listado completo</a>
                </center>
            </div> <!-- Cierre de la clase card card-body -->
